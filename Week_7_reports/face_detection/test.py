...
eyes_detect = cv2.CascadeClassifier(cv2.data.haarcascades+'haarcascade_eye.xml')
noise_detect = cv2.CascadeClassifier(cv2.data.haarcascades+'haarcascade_mcs_nose.xml')
